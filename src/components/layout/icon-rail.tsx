  ...
  return (
    <aside className="hidden md:flex h-screen w-16 shrink-0 flex-col items-center border-r border-sidebar-border bg-icon-background">
      ...
      <div className="flex w-full justify-center pt-3 pb-4">
        <button className="group flex size-10 items-center justify-center rounded-xl text-muted-foreground transition-all duration-300 hover:bg-accent hover:text-foreground">
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      >
        ...
        {/* Tooltip */}
        <span className="pointer-events-none absolute left-full ml-3 whitespace-nowrap rounded-md border border-border bg-popover px-2 py-1 text-xs font-medium text-popover-foreground shadow-lg opacity-0 -translate-x-1 transition-all duration-200 group-hover:translate-x-0 group-hover:opacity-100 z-50">
          {item.label}
        </span>
      </button>
      ...
      <div
        className={cn(
          ...
          open
            ...
            : "pointer-events-none opacity-0 scale-95 translate-x-2"
        )}
      >
        <div className="overflow-hidden rounded-xl border border-border bg-popover shadow-2xl">
          ...
          <Link
            ...
            className="flex items-center justify-between px-3 py-2 text-sm text-foreground transition-colors hover:bg-accent"
          >
            <span>Open link</span>
          ...
          <button
            type="button"
            onClick={copyLink}
            className="flex w-full items-center justify-between px-3 py-2 text-sm text-foreground transition-colors hover:bg-accent"
          >
            <span>Copy link</span>
